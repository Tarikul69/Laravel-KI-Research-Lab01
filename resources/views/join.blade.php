    ...
    <nav style="background-color: #353535;" id="tf-menu" class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/"><a class="" style="position: left;" href="/"><img class="navbar" src="admin/Logo.svg" style="color: white; hight: 50px; width: 55px;" alt=""></a><b class="" style="font-size: 20px; color: white;">KI Research Lab</b></a> 
        </div>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="section-title center">
                        <h2 style="font-size: 20px;"><strong>Subscribe to our newsletter</strong></h2>
                        <div class="line">
                            <hr>
                        </div>
                        <div class="clearfix"></div>
                        <form action="join1" class="form" method="POST">
                          @csrf
                            <input type="email" name="email" class="text" placeholder="Enter your email..">
