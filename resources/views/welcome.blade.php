...
<html lang="en">
  ...
  <body>
    ...
    ==========================================-->
    <!-- -->
<nav style="background-color: #333333;" id="tf-menu" class="navbar navbar-default navbar-fixed-top">
      <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-text">
                        <div class="font-size: 20px; section-title">
                            <h4>About us</h4>
                            <h2 style="font-size: 20px;">Some words <strong>about us</strong></h2>
                            <hr>
